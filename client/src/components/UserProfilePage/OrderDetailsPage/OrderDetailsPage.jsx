...
const OrderDetailsPage = ({
  ...
  const service_id = import.meta.env.VITE_EMAILJS_SERVICE_ID,
    ...
    user_id = import.meta.env.VITE_EMAILJS_API_PUBLIC_KEY;
  ...
  const fetchEventName = async () => {
    try {
      const response = await axios.get(
        ...
        }/eventify_server/eventTypes/getEventName/${order.eventId}`
      );
  ...
  const updateBookingToconfirm = async (bookingId) => {
    try {
      ...
      const updatedbookingresponse = await axios.put(
        `${
          import.meta.env.VITE_SERVER_URL
        }/eventify_server/bookingMaster/${bookingId}`,
        {
      ...
      const confirmedBookingResponse = await axios.get(
        `${
          import.meta.env.VITE_SERVER_URL
        }/eventify_server/bookingMaster/${bookingId}`
      );
      ...
      confirmedBooking.finalHallParkingRequirement =
        updatedbooking.parkingRequirement;
  ...
  const sendEmail = (bookinStatus, remarks) => {
    ...
    const bookingDetails = {
      ...
      bookedDateTime: new Date(
        order.bookingStartDateTimestamp
      ).toLocaleString(),
      ...
      <div className="vendor-details">
        <div className="customer-profile">
          <div className="customer-profile-image">
            <img
              src={
                order.customerData.customerProfileImage || Images.DefaultImage
              }
          ...
          <div className="customer-contact-details">
            ...
            <p>
              <FaUser />
              <strong>Name:</strong>{" "}
              {order.customerData.customerName || "Not defined"}
            </p>
            <p>
              <FaPhone /> <strong>Contact Number:</strong>{" "}
              {order.customerData.customerContact || "Not defined"}
            </p>
            <p>
              <FaPhone />
              <strong>Alternative Contact Number:</strong>{" "}
              {order.customerData.customerAlternateMobileNo || "Not defined"}
            </p>
            <p>
              <FaEnvelope />
              <strong>Email:</strong>{" "}
              {order.customerData.customerAlternateEmail || "Not defined"}
            </p>
            <p>
              <FaMapMarkerAlt />
              <strong>City:</strong>{" "}
              {order.customerData.customerCurrentLocation || "Not defined"}
            </p>
            <p>
              <FaCalendarAlt />
        ...
        <div className="booking-details">
          ...
          <div className="bookingdata-left">
            <p>
              ...
              {order.bookingType || "Not defined"}
            </p>
            <p>
              <FaClock />
              <strong>Booking Duration:</strong>
              {order.bookingDuration || "Not defined"}
            </p>
            <p>
              <FaCalendarAlt />
            ...
            <p>
              <FaParking />
              <strong>Parking Requirement:</strong>{" "}
              {order.parkingRequirement ? "Yes" : "No"}
            </p>
            <p>
              <FaUsers /> <strong>Guests Count:</strong>{" "}
              {order.guestsCount || "Not defined"}
            </p>
            <p>
              <FaBed />
              <strong>Rooms Count:</strong> {order.roomsCount || "Not defined"}
            </p>
            <p>
              <FaCarSide />
              <strong>Vehicles Count:</strong>{" "}
              {order.vehiclesCount || "Not defined"}
            </p>
            <p>
              <FaCalendarAlt />
              <strong>Event Type:</strong> {eventName || "Not defined"}
            </p>
          </div>
          <div className="bookingdata-right">
            <p>
              <FaUtensils />
              <strong>Book Caterer:</strong> {order.bookCaterer ? "Yes" : "No"}
            </p>
            {order.bookCaterer && (
              <>
                <p>
                  <FaUtensils /> <strong>Veg Items List:</strong>{" "}
                  {order.customerVegItemsList || "Not provided"}
                </p>
                <p>
                  <FaUtensils />
                  <strong>Veg Rate:</strong>{" "}
                  {order.customerVegRate || "Not provided"}
                </p>
                <p>
                  <FaUtensils />
                  <strong>Non-Veg Items List:</strong>{" "}
                  {order.customerNonVegItemsList || "Not provided"}
                </p>
                <p>
                  <FaUtensils />
                  <strong>Non-Veg Rate:</strong>{" "}
                  {order.customerNonVegRate || "Not provided"}
                </p>
              </>
            )}
          </div>
          <p className="customer-suggestion-full-width">
            <FaCommentAlt />
            <strong>Customer Suggestion:</strong>{" "}
            {order.customerSuggestion || "No suggestion provided"}
          </p>
        </div>
      </div>
    );
        ...
        <div className="vendor-profile">
          ...
          <div className="vendor-contact-details">
            ...
            <p>
              <FaUser />
              <strong>Name:</strong>{" "}
              {order.vendorData.vendorName || "Not defined"}
            </p>
            <p>
              <FaPhone />
              <strong>Contact Number:</strong>{" "}
              {order.vendorData.vendorContact || "Not defined"}
            </p>
            <p>
              <FaEnvelope />
              <strong>Email:</strong>{" "}
              {order.vendorData.vendorEmail || "Not defined"}
            </p>
            <p>
              <FaMapMarkerAlt />
              <strong>Address:</strong>{" "}
              {order.vendorData.vendorAddress || "Not defined"}
            </p>
            <p>
              <FaHotel />
              <strong>Hall Name:</strong> {order.hallName}
            </p>
            <p>
              <FaMapMarkerAlt />
              <strong>Hall Location:</strong> {getCompleteHallAddress(order)}
            </p>
            <p>
              <FaCalendarAlt />
              <strong>Date of Booking:</strong>{" "}
    ...
    return (
      <div>
        <div className="vendor-contact-details">
          ...
          <p>
            <FaUser />
            <strong>Name:</strong> {order.vendorData.vendorName}
          </p>
          <p>
            <FaPhone />
            <strong>Contact Number:</strong> {order.vendorContact}
          </p>
          <p>
            <FaEnvelope />
          ...
          <p>
            <FaMapMarkerAlt /> <strong>Address:</strong> {order.vendorAddress}
          </p>
        ...
        <div className="customer-contact-details">
          ...
          <p>
            <FaPhone />
            <strong>Contact Number:</strong> {order.customerContact}
          </p>
          <p>
            <FaEnvelope />
  ...
  return (
    <div className="custom-order-detail-page__container">
      <Dialog open={showRemarksDialog} onClose={() => setSelectedOption(null)}>
        ...
        <DialogActions>
          <Button onClick={() => handleRejectWithRemarks(remarks)}>
            Confirm
          </Button>
        </DialogActions>
      </Dialog>
      ...
      >
        ...
        <DialogContent>
          <DialogContentText id="confirmation-dialog-description">
            {`Are you sure you want to ${trimEd(
                      ...
                      <div className="status-option-container">
                        <div
                          className={`status-option ${
                            selectedOption === "ONHOLD" ? "selected" : ""
                          }`}
                        ...
                        <div
                          className={`status-option ${
                            selectedOption === "REJECTED" ? "selected" : ""
                          }`}
