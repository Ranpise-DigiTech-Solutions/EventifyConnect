...
export default function RegistrationForm({
  ...
  const handleFormSubmit = async () => {
    ...
    if (userType === "VENDOR") {
      ...
      URL = `${import.meta.env.VITE_SERVER_URL}/eventify_server/customerMaster/updateCustomerData/?documentId=${userInfo.userDetails.Document._id}&userId=${userInfo.userDetails.UID}`;
    }
