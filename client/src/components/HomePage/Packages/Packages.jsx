    ...
    if (totalPages <= 3) {
      ...
      for (let i = 1; i <= totalPages; i++) {
        pageNumbers.push(
          <div
            className={`counter ${
              currentPage === i ? "selected__counter" : ""
            }`}
            key={i}
      ...
      pageNumbers.push(
        <div className="counter selected__counter" key={currentPage}>
          {currentPage}
        </div>
      );
      pageNumbers.push(
      ...
      pageNumbers.push(
        <div
          className={`counter ${
            currentPage === totalPages ? "selected__counter" : ""
          }`}
          key={totalPages}
      ...
      pageNumbers.push(
        <div className="counter" key={1} onClick={() => handlePageChange(1)}>
          {1}
        </div>
      );
      pageNumbers.push(
      ...
      pageNumbers.push(
        <div
          className={`counter ${
            currentPage == totalPages - 1 && "selected__counter"
          }`}
          key={totalPages - 1}
    ...
    <div className="packages__container" id="packages" ref={wrapperRef}>
      ...
      >
        {filteredCards.length === 0 ? (
          <div className="altImg-container">
      ...
      <div className="packagecount__wrapper">
        <div className="counter" onClick={() => handlePageChange(1)}>
        ...
        <div className="counter" onClick={() => handlePageChange(totalPages)}>
