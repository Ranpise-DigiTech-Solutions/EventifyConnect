  ...
  return (
    <div className="privacyPolicy__container">
      ...
      <div className="wrapper">
        <h2 className="sub-heading">Information Collection</h2>
      ...
      <div className="wrapper">
        <h2 className="sub-heading">Legal Compliance and GDPR</h2>
        <p className="description">
          ...
          <a href="https://eventifyconnect.netlify.app" target="_blank">
      ...
      <div className="wrapper">
        <h2 className="sub-heading">Links to Other Websites</h2>
        <p className='description'>
      ...
      <div className="wrapper">
        <h2 className="sub-heading">Control of Your Password</h2>
        <p className="description">
      ...
      <div className="wrapper">
        <h2 className="sub-heading">Content on the site</h2>
        <p className='description'>
      ...
      <div className="wrapper">
        <h2 className="sub-heading">Updates on Privacy Policy</h2>
        <p className="description">
      ...
      <h1 className="heading">User Data Policy</h1>
      <div className="wrapper">
        <h2 className="sub-heading">Data points collected for users</h2>
        <p className='description'>
      ...
      <div className="wrapper">
        ...
        <table className='table' border="1" cellSpacing="0" cellPadding="5">
          <thead>
            <tr>
      ...
      <div className="wrapper">
        <h2 className='sub-heading'>Why Do We Need/Use the Above-Mentioned Data Points</h2>
        <p className='description'>
      ...
      <div className="wrapper">
        <h2 className='sub-heading'>In Case of Data Deletions</h2>
        <p className='description'>
